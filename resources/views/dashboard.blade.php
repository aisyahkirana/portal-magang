            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="display: block;">
                        Anda dapat melakukan Approval Magang pada Menu pada sidebar kiri.
                    </div>
                </div>
                @else
                    <div class="card">
                                    ...
                                    @foreach ($datadashboard as $d)
                                        <tr>
                                            ...
                                            @if ($d->status == 'notApprove')
                                                <td><span class="badge badge-pill badge-danger">Pengajuan Anda belum
                                                        Disetujui</td>
                                                <td><span class="badge badge-pill badge-danger">Pengajuan Anda belum
                                                        Disetujui</td>
                                            @elseif ($d->status == 'TidakApprove')
                                                <td><span class="badge badge-pill badge-danger">Pengajuan Anda di Tolak</td>
                                                <td><span class="badge badge-pill badge-danger">Pengajuan Anda di Tolak</td>
                                            @else
                                            <td><span class="badge badge-pill badge-success">Pengajuan Anda telah
                                                Disetujui</td>
                                        <td> <a href="{{ route('generate-pdf') }}"class="btn btn-success"><i
                                                    class="fas fa-download"></i> Download Approval</a></td>
                                            @endif
                                    @endforeach
                                </tbody>
                            </table>
